...
class BST:
    ...
    def traverse_pre (self):
        def _traverse_pre(node):
            if node is None:
                return []
            return [node.val] + _traverse_pre(node.left) + _traverse_pre(node.right)
        return _traverse_pre(self.root)
    ...
    def traverse_post (self):
        def _traverse_post(node):
            ...
            return _traverse_post(node.left) + _traverse_post(node.right) + [node.val]
        return _traverse_post(self.root)
